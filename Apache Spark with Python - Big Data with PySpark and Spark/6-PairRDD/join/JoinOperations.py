...
if __name__ == "__main__":
    ...
    join.saveAsTextFile("outputs/age_address_join.text")

    leftOuterJoin = ages.leftOuterJoin(addresses)
    leftOuterJoin.saveAsTextFile("outputs/age_address_left_out_join.text")

    rightOuterJoin = ages.rightOuterJoin(addresses)
    rightOuterJoin.saveAsTextFile("outputs/age_address_right_out_join.text")

    fullOuterJoin = ages.fullOuterJoin(addresses)
    fullOuterJoin.saveAsTextFile("outputs/age_address_full_out_join.text")
